...
namespace IdentityServer4.EntityFramework.Options
{
    ...
    public class ConfigurationStoreOptions
    {
        ...
        public TableConfiguration AspNetRole { get; set; } = new TableConfiguration("AspNetRoles");

        public TableConfiguration AspNetRoleClaim { get; set; } = new TableConfiguration("AspNetRoleClaims");

        public TableConfiguration AspNetUser { get; set; } = new TableConfiguration("AspNetUsers");


        public TableConfiguration AspNetUserClaim { get; set; } = new TableConfiguration("AspNetUserClaims");

        public TableConfiguration AspNetUserLogin { get; set; } = new TableConfiguration("AspNetUserLogins");

        public TableConfiguration AspNetUserRole { get; set; } = new TableConfiguration("AspNetUserRoles");

        public TableConfiguration AspNetUserToken { get; set; } = new TableConfiguration("AspNetUserTokens");
